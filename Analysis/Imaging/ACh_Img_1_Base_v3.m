...
%% Establish trials
if ProcPar_Base.trlIrrelevant == 1
    disp('Now we will only analyze around IRRELEVANT stimuli! Be careful when you define pre and post-onset window below!');
end
...
%% Save base data file
if ProcPar_Base.trlIrrelevant == 0
    save(strcat(fn_img.base,'_ImgBase'));
else
    save(strcat(fn_img.base,'_ImgBase_IRRE'));
end
